// Import all writing/content creation articles with FULL HTML rich text and SEO preservation
...
// Article mapping with facets - All writing articles
...
const articleMappings = [
    {
        ...
        facets: ['content_creation', 'copywriting', 'intermediate', 'step_by_step_guide', 'general']
    },
    {
        filename: 'blog-post.html',
        facets: ['content_creation', 'blog_post', 'intermediate', 'step_by_step_guide', 'general']
    },
    {
        filename: 'script-writing.html',
        facets: ['content_creation', 'script_writing', 'intermediate', 'step_by_step_guide', 'general']
    },
    {
        filename: 'website-content.html',
        facets: ['content_creation', 'website_content', 'intermediate', 'step_by_step_guide', 'general']
    }
];

async function importWritingArticles() {
    try {
        console.log('✍️ Importing Writing/Content Creation articles with RICH TEXT and SEO preservation...\n');
        ...
        const tempDir = path.join(__dirname, '..', 'temp', 'writing');
        let imported = 0;
        let updated = 0;
        ...
        const neededFacetValues = [
            'content_creation', 'blog_post', 'script_writing', 
        ...
        // Print summary
        console.log('═══════════════════════════════════════════════════════════════');
        console.log('🎉 WRITING/CONTENT CREATION ARTICLES IMPORT COMPLETED!');
        console.log('═══════════════════════════════════════════════════════════════');
...
if (require.main === module) {
    importWritingArticles();
}

module.exports = importWritingArticles;
