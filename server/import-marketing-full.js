// Import all marketing articles with FULL HTML rich text and SEO preservation
...
// Article mapping with facets - All marketing articles
// Note: Each article gets BOTH the parent 'sales_marketing' facet AND its specific subcategory
const articleMappings = [
    ...
    {
        filename: 'search-engine-marketing.html',
...
async function importMarketingArticles() {
    try {
        console.log('📢 Importing Marketing articles with RICH TEXT and SEO preservation...\n');
        ...
        const tempDir = path.join(__dirname, '..', 'temp', 'marketing');
        let imported = 0;
        let updated = 0;
        ...
        const neededFacetValues = [
            'sales_marketing', 'content_marketing', 'email_marketing', 
            'inbound_outbound_marketing', 'influencer_marketing', 
            'search_engine_marketing', 'seo', 'social_media_marketing'
        ];
        ...
        // Print summary
        console.log('═══════════════════════════════════════════════════════════════');
        console.log('🎉 MARKETING ARTICLES IMPORT COMPLETED!');
        console.log('═══════════════════════════════════════════════════════════════');
...
if (require.main === module) {
    importMarketingArticles();
}

module.exports = importMarketingArticles;
