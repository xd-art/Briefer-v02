// Import all video articles with FULL HTML rich text and SEO preservation
...
// Article mapping with facets - All video articles
// Note: Each article gets BOTH the parent 'motion_graphics' facet AND its specific subcategory
...
async function importVideoArticles() {
    try {
        ...
        const neededFacetValues = [
            'motion_graphics', 'explainer_video', 'intro_outro', 
            'logo_animation', 'montage_video', 
            'video_advertising', 'whiteboard_animation'
        ];
        ...
        // Print summary
        console.log('═══════════════════════════════════════════════════════════════');
        console.log('🎉 VIDEO/MOTION GRAPHICS ARTICLES IMPORT COMPLETED!');
        console.log('═══════════════════════════════════════════════════════════════');
...
module.exports = importVideoArticles;
